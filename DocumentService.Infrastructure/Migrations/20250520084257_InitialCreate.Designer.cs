...
namespace DocumentService.Infrastructure.Migrations
{
    ...
    [Migration("20250520084257_InitialCreate")]
            ...
            modelBuilder.Entity("DocumentService.Domain.Entities.Passport", b =>
                {
                    ...
                    b.ToTable("Documents", t =>
                        {
                            t.Property("CreatedTime")
                                .HasColumnName("Passport_CreatedTime");

                            t.Property("ModifiedTime")
                                .HasColumnName("Passport_ModifiedTime");
                        });
